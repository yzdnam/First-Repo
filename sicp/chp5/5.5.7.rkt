...
; 5.5.7.1.rkt has solution to EX 5.50. This file contains the first attempt
               ...
               '(begin
                  ...
                  (define (eval-assignment exp env)
                    (let ((var (assignment-variable exp))
                        ...
                        (set-variable-value! var (eval vproc env) env)
                        'ok))
                  ...
                  (define (eval-definition exp env)
                    (let ((var (definition-variable exp))
                        ...
                        (define-variable! var (eval vproc env) env)
                        'ok))
