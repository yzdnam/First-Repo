...
(define input-prompt ";;; AmbQ-Eval input:")
(define output-prompt ";;; AmbQ-Eval value:")
(define (driver-loop)
             ...
             (begin
               ...
               (ambeval
                ...
                (lambda (frame next-alternative)
                  ...
                  (display (instantiate input frame (lambda (v f) (contract-question-mark v))))
...
(define (ambeval query frame-stream succeed fail)
  ((amb-stream (qeval query frame-stream)) succeed fail))

(define (amb-stream frame-stream)
  (lambda (succeed fail)
