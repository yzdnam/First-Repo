...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname 8.1-8.2) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
(define (our-first a-list)
  (if (empty? a-list)
      (error 'our-first "...")      (pair-left a-list)))
