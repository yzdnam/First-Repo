...
class ExamplesBooks {
    ...
    // test the method allBooksBefore
    boolean testallBooksBefore(Tester t) {
      return
      t.checkExpect(this.twoBooks.allBooksBefore(2015), new ConsLoBook(this.htdp, this.mtList)) &&
      t.checkExpect(this.threeBooks.allBooksBefore(2000), new ConsLoBook(this.gatsby,
                                                              this.mtList)) &&
