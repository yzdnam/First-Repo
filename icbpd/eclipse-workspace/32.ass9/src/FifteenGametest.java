...
class ExampleFifteenGame {
  void testGame(Tester t) {
    FifteenGametest g = new FifteenGametest();
    g.bigBang(120, 120);
  } 
...
class Tile implements FifteenGameConsts { 
...
class FifteenGametest extends World implements FifteenGameConsts {
...
/*    tiles = new ArrayList<ArrayList<Tile>>();
    ...
    for (col = 0;
      ...
      for (row = 0;
          row < 4;
          row = row + 1) {
        tiles.get(row).add(new Tile(nextI, row, col));
        nextI = nextI + 1;
      }
    } 
  }
