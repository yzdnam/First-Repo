...
interface IList<T> {
  ...
  boolean equals(IList<T> otherList);

  boolean equalsMtList(MtList<T> otherList);

  boolean equalsConsList(ConsList<T> otherList);
}
...
class MtList<T> implements IList<T> {
  ...
  public ConsList<T> asCons() {
    throw new IllegalArgumentException("asCons() called on an MtList");
  }
  
  public boolean equals(IList<T> otherList) { return otherList.equalsMtList(this); }
  
  public boolean equalsMtList(MtList<T> otherList) { return true; }
  
  public boolean equalsConsList(ConsList<T> otherList) { return false; }
}
...
class ConsList<T> implements IList<T> {
  ...
  public boolean equals(IList<T> otherList) { return otherList.equalsConsList(this); }
  
  public boolean equalsMtList(MtList<T> otherList) { return false; }
  
  public boolean equalsConsList(ConsList<T> otherList) {
    return first.equals(otherList.first) && this.rest.equals(otherList);
  }
}