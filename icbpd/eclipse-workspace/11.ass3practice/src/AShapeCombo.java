...
class BoundingBox {
  ...
  int top;
  int bot;
  BoundingBox(int lft, int rgt, int bot, int top) {
    this.lft = lft;
    this.rgt = rgt;
    this.top = top;
    this.bot = bot;
...
interface IShape {
    ...
    // determines whether this shape is of equal size as some other, given IShape up to some given small number delta
...
abstract class AShape implements IShape {
    ...
    public abstract BoundingBox bb();
...
class Circle extends AShape {
    ...
    // to increase the size of this shape by the given increment
    public IShape grow(int inc){
        return new Circle(this.loc, this.radius + inc);
    }
    ...
    public BoundingBox bb() {
      return new BoundingBox(this.loc.x-this.radius, this.loc.x+this.radius, this.loc.y-this.radius, this.loc.y+this.radius);
    }
...
class Rect extends AShape {
    ...
    Rect(CartPt nw, int width, int height) {
        super(nw);
        this.width = width;
        this.height = height;
    }
    ...
    public BoundingBox bb() {
      return new BoundingBox(this.loc.x, this.loc.x+this.width, this.loc.y, this.loc.y+this.height);
    }
...
class Square extends Rect {
    ...
    // to increase the size of this shape by the given increment
    public IShape grow(int inc){
        return new Square(this.loc, this.width + inc);
    }
}
...
class CartPt {
    ...
    public CartPt translate(int delta) {
...
class ExamplesShapes {
    ...
    IShape c1 = new Circle(new CartPt(50, 50), 10);
    IShape c2 = new Circle(new CartPt(50, 50), 30);
    IShape c3 = new Circle(new CartPt(30, 100), 30);
    IShape c4 = new Circle(new CartPt(12, 5), 2);
    IShape c5 = new Circle(new CartPt(50, 120), 20);
    IShape c6 = new Circle(new CartPt(30, 40), 20);
    
    IShape s1 = new Square(new CartPt(50, 50), 30);
    IShape s2 = new Square(new CartPt(50, 50), 50);
    IShape s3 = new Square(new CartPt(20, 40), 10);
    IShape s4 = new Square(new CartPt(40,30), 40);
    IShape s5 = new Square(new CartPt(120, 50), 50);
    
    IShape r1 = new Rect(new CartPt(50, 50), 30, 20);
    IShape r2 = new Rect(new CartPt(50, 50), 50, 40);
    IShape r3 = new Rect(new CartPt(20, 40), 10, 20);
    
    IShape cb1 = new Combo(this.r1, this.c1);
    IShape cb2 = new Combo(this.r2, this.r3);
    IShape cb3 = new Combo(this.cb1, this.cb2);
    IShape u1 = new Combo(this.s4, this.s5);
    IShape u2 = new Combo(this.s4, this.c6);
    IShape u3 = new Combo(this.c5, this.u1);
    IShape u4 = new Combo(this.u3, this.u2);
    
    boolean testSame(Tester t) {
      return
          t.checkExpect(this.c2.same(c3, 0.01), true) &&
          t.checkExpect(this.r1.same(r2, 0.001), false);
    }
    
    boolean testBB(Tester t) {
      return
          t.checkExpect(this.s4.bb(), new BoundingBox(40,80,30,70)) &&
          t.checkExpect(this.s5.bb(), new BoundingBox(120,170,50,100)) &&
          t.checkExpect(this.c5.bb(), new BoundingBox(30,70,100,140)) &&
          t.checkExpect(this.u1.bb(), new BoundingBox(40,170,30,100)) &&
          t.checkExpect(this.u2.bb(), new BoundingBox(10,80,20,70)) &&
          t.checkExpect(this.u3.bb(), new BoundingBox(30,170,30,140)) &&
          t.checkExpect(this.u4.bb(), new BoundingBox(10,170,20,140)); 
    }
