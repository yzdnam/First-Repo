...
(define (remove-lets-and-pairs mp)
  (letrec ([rm (lambda (e)
                 (cond [(var? e) e]
                       [(int? e) e]
                       [(add? e) (add (rm (add-e1 e)) (rm (add-e2 e)))]
                       [(ifgreater? e) (ifgreater (rm (ifgreater-e1 e)) (rm (ifgreater-e2 e))
                                                  (rm (ifgreater-e3 e)) (rm (ifgreater-e4 e)))]
                       [(fun? e) (fun (fun-nameopt e) (fun-formal e) (rm (fun-body e)))]
                       [(call? e) (call (rm (call-funexp e)) (rm (call-actual e)))]
                       [(mlet? e) (call (fun #f (mlet-var e) (rm (mlet-body e))) (rm (mlet-e e)))]
                       [(apair? e) (rm (mlet "_x" (rm (apair-e1 e)) (fun #f "_f" (call (call (var "_f") (var "_x")) (mlet "_x" (rm (apair-e2 e)) (var "_x"))))))]
                       [(fst? e) (call (rm (fst-e e)) (fun #f "x" (fun #f "y" (var "x"))))]
                       [(snd? e) (call (rm (snd-e e)) (fun #f "x" (fun #f "y" (var "y"))))]
                       [(aunit? e) e]
                       [(isaunit? e) (isaunit (rm (isaunit-e e)))]
                       [(closure? e) (closure (closure-env e) (rm (closure-fun e)))]))])
    (rm mp)))

(define mupl-all
  (fun "mupl-all" "mlist" (ifaunit (var "mlist")
                                   (int 1)
                                   (ifeq (int 1) (fst (var "mlist")) (call (var "mupl-all") (snd (var "mlist"))) (int 0)))))
(eval-exp (call mupl-all (apair (int 1) (apair (int 0) (aunit)))))

(define mupl-append
  (fun "mupl-append" "xlist"
       (fun #f "ylist" (ifaunit (var "xlist")
                                (var "ylist")
                                (apair (fst (var "xlist")) (call (call (var "mupl-append") (snd (var "xlist"))) (var "ylist")))))))
;(eval-exp (call (call mupl-append (apair (int 1) (apair (int 2) (aunit)))) (apair (int 3) (apair (int 4) (aunit)))))
...
(define mupl-zip
  (fun "mupl-zip" "xlist"
       (fun #f "ylist" (ifaunit (var "xlist")
                                ...
                                (ifaunit (var "ylist")
                                         (aunit)
                                         (apair (apair (fst (var "xlist")) (fst (var "ylist"))) (call (call (var "mupl-zip")
                                                                                                            (snd (var "xlist")))
                                                                                                      (snd (var "ylist")))))))))
;(eval-exp (call (call mupl-zip (apair (int 1) (apair (int 2) (aunit)))) (apair (int 3) (apair (int 4) (aunit)))))

(define mupl-append2
  (fun "mupl-append" "2lists"
       (mlet "xlist" (fst (var "2lists"))
             (mlet "ylist" (snd (var "2lists"))
                   (ifaunit (var "xlist")
                            (var "ylist")
                            (apair (fst (var "xlist")) (call (var "mupl-append") (apair (snd (var "xlist")) (var "ylist")))))))))

(eval-exp (call mupl-append2 (apair (apair (int 1) (apair (int 2) (aunit))) (apair (int 3) (apair (int 4) (aunit))))))
       ...
       (mlet "xlist" (fst (var "2lists"))
             (mlet "ylist" (snd (var "2lists"))
                   (ifaunit (var "xlist")
                                ...
                                (ifaunit (var "ylist")
                                         (aunit)
                                         (apair (apair (fst (var "xlist")) (fst (var "ylist"))) (call (var "mupl-zip")
                                                                                                      (apair (snd (var "xlist"))
                                                                                                             (snd (var "ylist")))))))))))

(eval-exp (call mupl-zip2 (apair (apair (int 1) (apair (int 2) (aunit))) (apair (int 3) (apair (int 4) (aunit))))))
...
(eval-exp (call (call (call mupl-curry mupl-append2) (apair (int 1) (apair (int 2) (aunit)))) (apair (int 3) (apair (int 4) (aunit)))))
...
(eval-exp (call (call mupl-uncurry mupl-append) (apair (apair (int 1) (apair (int 2) (aunit))) (apair (int 3) (apair (int 4) (aunit))))))

(define (if-greater3 e1 e2 e3 e4 e5)
  (mlet "_x" e1
        (mlet "_y" e2
              (mlet "_z" e3
                    (ifgreater (var "_y") (var "_z") (ifgreater (var "_x") (var "_y") e4 e5) e5)))))

(eval-exp (if-greater3 (int 4) (int 3) (int 2) (int 1) (int 0)))

(define call-curried
  (lambda (e1 mlist)
    (if (null? (cdr mlist))
        (call e1 (car mlist))
        (call-curried (call e1 (car mlist)) (cdr mlist)))))

(eval-exp (call-curried mupl-append (list (apair (int 1) (apair (int 2) (aunit))) (apair (int 3) (apair (int 4) (aunit))))))